...
| Trang | URL (mẫu) |
|-------|-----------|
| Trang chủ / pitch (SEO) | `{BASE_URL}/` — `@linm/fnb-seo` |
| Báo giá | `{BASE_URL}/pricing` |
| Demo UI tương tác | `{BASE_URL}/demo/app-demo.html` |
| Luồng kỹ thuật | `{BASE_URL}/demo/workflow-demo.html` |
| Legacy static (deprecated) | `index.html` / `pricing.html` trong repo Demo |
